document.getElementById("studentForm").addEventListener('submit', function(e) {
  ...
  td4.innerHTML = `<button class="edit-btn btn btn-success m-2" onclick="editRow(this)">Edit</button> 
  <button class="delete-btn btn btn-danger m-2" onclick="deleteRow(this)">Delete</button>`;
